...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGFzd2FyYWJiYXNzc3MiLCJhIjoiY2w1dHV5NXgxMDlocDNqbGFla283NjlleiJ9.l5ukIHd4C6HXMTVdDop-eA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/taswarabbassss/cl5tvq8mp000y15o5irlwupxd',
    scrollZoom: false // center: [73.028725, 33.65939],
    // zoom: 7
    // interactive: false
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
              data: data // url:'http://127.0.0.1:3000/api/v1/users/updateMe',
              // data: {
              //   name: name,
              //   email: email
              // }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // Stripe Function
            stripe = Stripe('pk_test_51LP3SPC4n1q3gb8iRCmY6zEhpFA24no0K3g39xNZajBYs8w8ALBkGGYpWLqeKtot3WM5UW1KhrPyLn2PugWg9U9D00h5bbwmG2');
            _context.prev = 1;
            _context.next = 4;
...
var bookTourBtn = document.getElementById('book-tour'); // DELEGATIONS
